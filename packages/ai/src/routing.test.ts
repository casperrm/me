...
// Postgres needed — this is a pure function. Moved here from
// apps/web/src/lib/cedar-brain.test.ts alongside routing.ts itself. See
// docs/specs/ai-eval-harness.md for the real bug this fix closed (found
// by building the AI Evaluation Harness): plain .includes() substring
// matching meant "script" matched inside "description" and "ad" matched
// inside "already"/"administrator".
import { describe, expect, it } from "vitest";
import { routeToAgents } from "./routing";
