...
// not cover. Moved here from apps/web/src/lib/services/eval-service.ts
// alongside ../routing.ts so apps/worker's scheduled eval job
// (apps/worker/src/jobs/ai-eval.ts) can call runRoutingEval() without
// crossing the apps/worker → apps/web boundary.
import { prisma } from "@cedar/db";
import { routeToAgents, type CedarAgent } from "./routing";
